...
fun manipulateString(str: String, int: Int): String {
    val stringTrimmed = str.trimStart('0')
    return if (stringTrimmed.any { it.isDigit() }) {
        val firstIndex = stringTrimmed.indexOfFirst { it.isDigit() }
        val partOfString = str.substring(0, firstIndex)
        val partOfNumber = str.substring(firstIndex)
        val number = partOfNumber.toInt() * int
